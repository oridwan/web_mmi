...
function(s){
var f = JU.SimpleUnitCell.parseCalc(this.vwr, J.adapter.smarter.AtomSetCollectionReader.functions, s);
if (Float.isNaN(f)) {
JU.Logger.error("AtomSetCollection math error parsing " + s);
}return f;
}, "~S");
